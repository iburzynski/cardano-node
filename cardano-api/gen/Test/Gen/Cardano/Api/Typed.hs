...
exampleCostModelV1 :: CostModel
exampleCostModelV1 = CostModel $ Map.fromList
...
exampleCostModelV2 :: CostModel
exampleCostModelV2 = CostModel $ Map.fromList
  [ ( "addInteger-cpu-arguments-intercept", 0)
  , ( "addInteger-cpu-arguments-slope", 0)
  , ( "addInteger-memory-arguments-intercept", 0)
  , ( "addInteger-memory-arguments-slope", 0)
...
genCostModel lang = do
  let costModelParams = case lang of
        PlutusV1 -> unCostModel exampleCostModelV1
        PlutusV2 -> unCostModel exampleCostModelV2

  eCostModel <- Alonzo.mkCostModel lang
